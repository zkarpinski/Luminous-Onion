...
const NewSourcePopupComponent = (props) => {
  ...
  const handleOpen = () => {
    ...
    api.get("/api/resources/sourcetools").then((data) => setSourceTools(data));
              ...
              <Grid container spacing={1}>
                <Grid item xs={12}>
                  <TextField
                    ...
                    id="label"
                    name="label"
                    placeholder="Enter label for new source"
                    fullWidth
